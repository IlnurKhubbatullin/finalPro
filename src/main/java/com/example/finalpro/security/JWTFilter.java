package com.example.finalpro.security;
        ...
        if(authHeader != null && !authHeader.isBlank() && authHeader.startsWith("Bearer ")){
            ...
            if(jwt == null || jwt.isBlank()){
                ...
                try{
                    ...
                    String name = jwtUtil.validateTokenAndRetrieveSubject(jwt); // сравнение токена


                    UserDetails userDetails = userDetailsService.loadUserByUsername(name); // поиск имени в бд. Имя пороль в токен
