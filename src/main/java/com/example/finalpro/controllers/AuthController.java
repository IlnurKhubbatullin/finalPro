...
import com.example.finalpro.services.PeopleService;
import com.example.finalpro.services.RegistrationService;
import com.example.finalpro.validate.PersonValidator;
...
public class AuthController {
    ...
    public String setAdminOrUser(@ModelAttribute("employeeForm") Person getPerson,
        ...
        if(action.contains("Создать администратора")){  //действие
